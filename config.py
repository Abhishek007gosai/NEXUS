...
APP_ID = int(os.environ.get("APP_ID", "") or "0")  # Your API ID from my.telegram.org
...
<b>›› /dbroadcast :</b> ʙʀᴏᴀᴅᴄᴀsᴛ ᴡɪᴛʜ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ (ᴜsᴀɢᴇ: /dbroadcast {seconds})
<b>›› /pbroadcast :</b> ʙʀᴏᴀᴅᴄᴀsᴛ & ᴘɪɴ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
<b>›› /ban :</b> ʙᴀɴ ᴀ ᴜꜱᴇʀ
